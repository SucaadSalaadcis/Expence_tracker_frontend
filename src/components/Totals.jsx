...
export default function Totals() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const usersRes = await axios.get('https://expence-tracker-backend-yai4.onrender.com/users');
                setUsersCount(usersRes.data.length);

                const expenseRes = await axios.get('https://expence-tracker-backend-yai4.onrender.com/expences');
